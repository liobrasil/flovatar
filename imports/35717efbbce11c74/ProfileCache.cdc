...
access(all) contract ProfileCache {
	...
	access(all) fun setAddressLeaseNameCache(address: Address, leaseName: String?, validUntil: UFix64) {
	...
	access(all) fun setNameAddressCache(address: Address?, leaseName: String, validUntil: UFix64) {
