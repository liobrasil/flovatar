...
access(all) contract DapperUtilityCoin : FungibleToken {
    ...
    access(all) resource Vault: FungibleToken.Vault {
       ...
       /// Asks if the amount can be withdrawn from this vault
        ...
        access(all) view fun getDefaultPublicPath(): PublicPath? {
            return /public/dapperUtilityCoinReceiver
        }
        ...
        switch viewType {
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    ...
                    metadataPath: /public/dapperUtilityCoinReceiver,
    ...
    init() {
        ...
        self.account.capabilities.publish(vaultCap, at: /public/dapperUtilityCoinReceiver)
    }
}
